...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["Apple", "Samsung", "Oppo", "Nokia", "Huawei", "Xiaomi", "Realme", "Vivo", "Philips", "Mobell", "Mobiistar", "Itel", "Coolpad", "HTC", "Motorola", "Hoa bán lẻ", "Bó hoa len", "Phụ kiện len", "Len trang trí"];
