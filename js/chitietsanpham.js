...
function phanTich_URL_chiTietSanPham() {
    ...
    // Đổi title
    document.title = nameProduct + ' - Hoa len';
    ...
    s += addThongSo('Chất liệu', sanPhamHienTai.detail.os);
    s += addThongSo('Gửi từ', sanPhamHienTai.detail.camara);
    s += addThongSo('Chiều dài', sanPhamHienTai.detail.camaraFront);
