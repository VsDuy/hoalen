...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo-soi.png" alt="Trang chủ Hoa len Store" title="Trang chủ Hoa len Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Hoa len Store</a> - All rights reserved © 2024 - Designed by
